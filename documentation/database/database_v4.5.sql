...
(27, 1, 1, 'Super Admin', '1234856975', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.86 Safari/537.36', 'Has been logged in', 1, '2019-03-28 11:39:43', '2019-03-28 11:39:43', 1, 1);
...
(1, NULL, NULL, NULL, '', 0, 0.00, 0, '', 0, 0.00, 0, '', '', 0, 0.00, 0, NULL, NULL, 1, 0.00, 0, NULL, NULL, NULL, NULL, 0, 0.00, 0, 1, '2017-08-24 10:58:24', '2018-04-15 01:30:13', 1, 1);
...
(10, 'servent', 'Servent', 'Servant User', 0, 1, '2018-02-04 04:40:37', '2018-02-09 02:03:09', 1, 1);
...
CREATE TABLE `settings` (
  ...
  `map_api_key` varchar(255) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `settings` (`id`, `school_code`, `school_name`, `registration_date`, `address`, `phone`, `email`, `currency`, `currency_symbol`, `language`, `footer`, `logo`, `front_logo`, `session_start_month`, `session_end_month`, `academic_year_id`, `running_year`, `school_fax`, `school_lat`, `school_lng`, `enable_rtl`, `enable_frontend`, `final_result_type`, `default_time_zone`, `sms_date_format`, `google_analytics`, `map_api_key`, `about_text`, `about_image`, `facebook_url`, `twitter_url`, `linkedin_url`, `google_plus_url`, `youtube_url`, `instagram_url`, `pinterest_url`, `status`, `created_at`, `modified_at`, `created_by`, `modified_by`) VALUES
(1, '123456', 'Windsor Park High School', '2018-12-01', '10433 Wolverine Way  Bellevue, CA 98456', '0123456789', 'info@gsms.com', 'US', '$', 'english', 'Copyright © Windsor Park High School 2018', '1523268322-school-logo.png', '1544101067-front-logo.png', 'july', 'june', 1, 'July 2018 - June 2019', '346546', '23.777176', '90.399452', 0, 1, 1, 'Asia/Dhaka', 'M j, Y', '', '', 'when delete school all element like student teacher guardian class did not delete and can not assign another school for these element.<p><br><p><b>when delete school</b> all element like student teacher guardian class did not delete and can not assign another school for these element.<br></p><p>when delete school all element like student teacher guardian class did not delete and can not assign <span style=\"font-size:18px;\">another school </span>for these element.<br></p><p>when delete school all element like student teacher guardian class did not delete and can not assign another school for these element.<br></p></p>', '', '', '', '', '', '', '', '', 1, '2017-08-23 09:40:28', '2019-03-28 16:27:17', 1, 1);
...
(1, '', '', 1, 'e10adc3949ba59abbe56e057f20f883e', 'MTIzNDU2Nw==', 'superadmin@gsms.com', '', 1, '2019-03-28 11:39:43', '2013-11-15 20:33:03', '2019-03-17 15:42:02', 0, 1);

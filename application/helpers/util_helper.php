...
if (!function_exists('get_user_by_role')) {
    ...
    function get_user_by_role($role_id, $user_id) {
        ...
        if ($role_id == STUDENT) {
            ...
            $ci->db->select('S.*, G.name AS guardian, E.roll_no, E.section_id, E.class_id, U.email, U.role_id, R.name AS role, C.name AS class_name, SE.name AS section, D.title AS discount');
            $ci->db->from('enrollments AS E');
            ...
            $ci->db->select('T.*, U.email, U.role_id, R.name AS role, SG.grade_name');
            ...
            $ci->db->select('G.*, U.email, U.role_id, R.name AS role');

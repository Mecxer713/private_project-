            ...
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    <tr>
                        ...
                        <td  width="30%"><?php echo $student->admission_no; ?></td>
                        <th  width="20%"><?php echo $this->lang->line('name'); ?></th>
                        <td  width="30%"><?php echo $student->name; ?></td>
                    </tr>
                    <tr> 
                        <th><?php echo $this->lang->line('admission'); ?> <?php echo $this->lang->line('date'); ?></th>
                        <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($student->admission_date)); ?></td>
                        <th><?php echo $this->lang->line('birth_date'); ?></th>
                        <td><?php echo date($this->gsms_setting->sms_date_format, strtotime($student->dob)); ?></td>
                    </tr>
                    <tr>
        ...
        <div  class="tab-pane fade in " id="tab_guardian_info" >
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <th><?php echo $this->lang->line('other_info'); ?></th>
                        <td colspan="3"><?php echo $guardian->other_info; ?>   </td>
                    </tr>
                </tbody>
            </table>  
        </div>

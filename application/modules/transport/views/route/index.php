                               ...
                               <?php echo form_open(site_url('transport/route/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($post['title']) ?  $post['title'] : ''; ?>" placeholder="<?php echo $this->lang->line('transport_route'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="route_start"  id="route_start" value="<?php echo isset($post['route_start']) ?  $post['route_start'] : ''; ?>" placeholder="<?php echo $this->lang->line('route_start'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="route_end"  id="route_end" value="<?php echo isset($post['route_end']) ?  $post['route_end'] : ''; ?>" placeholder="<?php echo $this->lang->line('route_end'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                         <table style="width:100%;" class="fn_add_stop_container responsive"> 
                                             <tr>               
                                                 ...
                                                 <td><?php echo $this->lang->line('stop_fare'); ?> (<?php echo $this->gsms_setting->currency_symbol; ?>)</td>
                                             </tr>
                                            <tr>               
                                              <td>
                                                  <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type="text" name="stop_name[]" placeholder="<?php echo $this->lang->line('stop_name'); ?>" autocomplete="off"/>
                                              </td>
                                              <td>
                                                  <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type='text' name="stop_km[]" value="" placeholder="<?php echo $this->lang->line('stop_km'); ?>" autocomplete="off"/>
                                              </td>
                                              <td>
                                                  <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type='text' name="stop_fare[]" value="" placeholder="<?php echo $this->lang->line('stop_fare'); ?>" autocomplete="off"/>
                                              </td>
                                              <td>
                                              </td>
                                            </tr>                                           
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('transport/route/edit/'.$route->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($route->title) ?  $route->title : $post['title']; ?>" placeholder="<?php echo $this->lang->line('transport_route'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>                          
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="route_start"  id="route_start" value="<?php echo isset($route->route_start) ?  $route->route_start : $post['route_start']; ?>" placeholder="<?php echo $this->lang->line('route_start'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('route_start'); ?></div>
                                    </div>
                                </div>                          
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="route_end"  id="route_end" value="<?php echo isset($route->route_end) ?  $route->route_end : $post['route_end']; ?>" placeholder="<?php echo $this->lang->line('route_end'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('route_end'); ?></div>
                                    </div>
                                </div>                          
                                         ...
                                         <table style="width:100%;" class="fn_edit_stop_container responsive"> 
                                            ...
                                            <tr>               
                                              <td>                                                  
                                                  ...
                                                  <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type="text" name="stop_name[]" value="<?php echo $obj->stop_name; ?>" placeholder="<?php echo $this->lang->line('stop_name'); ?>" autocomplete="off" />
                                              </td>
                                              <td>
                                                  <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type='text' name="stop_km[]" value="<?php echo $obj->stop_km; ?>" placeholder="<?php echo $this->lang->line('stop_km'); ?>" autocomplete="off"/>
                                              </td>
                                              <td>
                                                  <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type='text' name="stop_fare[]" value="<?php echo $obj->stop_fare; ?>" placeholder="<?php echo $this->lang->line('stop_fare'); ?>" autocomplete="off"/>
                                              </td>
                                              <td>
                                                  <?php if($couter > 1){ ?>

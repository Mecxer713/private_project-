<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
    <tbody>
        <tr>
            <th width="20%"><?php echo $this->lang->line('transport_route'); ?> <?php echo $this->lang->line('title'); ?> </th>
            ...
            <td>
                <table style="width:100%;" class="fn_edit_stop_container responsive"> 
                    <tr>               
                        ...
                        <th><?php echo $this->lang->line('stop_fare'); ?> (<?php echo $this->gsms_setting->currency_symbol; ?>)</th>
                    </tr>

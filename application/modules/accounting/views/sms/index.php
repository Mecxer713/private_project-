                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                    ...
                                    <?php $count = 1; if(isset($texts) && !empty($texts)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } ?>
                                                <?php if(has_permission(VIEW, 'accounting', 'duefeesms')){ ?>     
                                                    <a href="<?php echo site_url('accounting/duefeesms/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_sms">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('accounting/duefeesms/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">  
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="receiver_id"><?php echo $this->lang->line('due_fee'); ?> <?php echo $this->lang->line('student'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
 ...
 <script type="text/javascript">
   ...
   function get_user(class_id){
       ...
       $.ajax({       
            ...
            data   : { role_id : role_id , class_id: class_id},               
            async  : false,
            success: function(response){                                                   
               if(response)
               {

                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            <?php $position = get_position_in_class($current_class_id, @$result->avg_grade_point); ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" value="<?php if(isset($enroll)){ echo $enroll->roll_no;}else{ } ?>"  name="roll_no[<?php echo $obj->id; ?>]"  class="form-control col-md-7 col-xs-12 small-field" required="required" />
                                    </td>
                                </tr>
                            <?php } ?>
                        <?php }else{ ?>

                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(VIEW, 'academic', 'syllabus')){ ?>
                                                    ...
                                                    <?php } ?>
                                                    <a  onclick="get_syllabus_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-syllabus-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                                                <?php } ?>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('academic/syllabus/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 quick-field"  name="class_id"  id="class_id" required="required" onchange="get_subject_by_class(this.value, '');" >
                               ...
                               <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo $this->lang->line('syllabus'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">

                            ...
                            <div class="x_content">
                               ...
                               <?php echo form_open(site_url('announcement/notice/edit/'.$notice->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="date"  id="edit_date" value="<?php echo isset($notice->date) ?  $notice->date : $post['date']; ?>" placeholder="<?php echo $this->lang->line('date'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('date'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="notice"><?php echo $this->lang->line('notice'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="notice"  id="edit_notice" required="required" placeholder="<?php echo $this->lang->line('notice'); ?>"><?php echo isset($notice->notice) ?  $notice->notice : $post['notice']; ?></textarea>
                                        <div class="help-block"><?php echo form_error('notice'); ?></div>
                                    </div>
                                </div>

            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'guardian', 'feedback') && empty($feedbacks)){ ?>
                        
                            <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('guardian/feedback/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('feedback'); ?></a> </li>                          
                             <?php }else{ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#tab_add_feedback"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('feedback'); ?></a> </li>                          
                             <?php } ?>
                    ...
                    <div class="tab-content">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(!$obj->is_publish){ ?>
                                                    <?php if(has_permission(EDIT, 'guardian', 'feedback')){ ?>
                                                        <a href="<?php echo site_url('guardian/feedback/edit/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                    <?php } ?>                                                
                                                    <?php if(has_permission(DELETE, 'guardian', 'feedback')){ ?>
                                                        <a href="<?php echo site_url('guardian/feedback/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                    <?php } ?>
                                                <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_feedback">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('guardian/feedback/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                         <input type="hidden" value="<?php echo $this->session->userdata('school_id'); ?>" name="school_id" />
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_feedback">
                            <div class="x_content">
                               ...
                               <?php echo form_open(site_url('guardian/feedback/edit/'.$feedback->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>

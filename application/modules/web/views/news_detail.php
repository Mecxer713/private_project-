            ...
            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                <div class="page-news-details">
                    ...
                    <ul class="meta">
                        ...
                        <li class="info"><span class="icon"><i class="far fa-calendar-alt"></i></span> <?php echo date($this->setting->sms_date_format, strtotime($news->date)); ?></li>
                    </ul>
                    
                    <h2 class="title"><?php echo $news->title; ?></h2>                   
                    <div class="text"><?php echo $news->news; ?></div>                   
                                     ...
                                     <a href="<?php echo site_url('news-detail/'.$obj->id); ?>">
                                         ...
                                         <span class="content">
                                             <span class="meta">
                                                 ...
                                                 <span class="info"><span class="icon"><i class="far fa-calendar-alt"></i></span> <?php echo date($this->setting->sms_date_format, strtotime($obj->date)); ?></span>
                                             </span>

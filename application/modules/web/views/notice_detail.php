<section class="page-breadcumb-area bg-with-black">
    <div class="container text-center">
        ...
        <ul class="links">
            ...
            <li><a href="<?php echo site_url('notice'); ?>"><?php echo $this->lang->line('notices'); ?></a></li>
            <li><a href="javascript:void(0);"><?php echo $this->lang->line('notice'); ?> <?php echo $this->lang->line('detail'); ?></a></li>
        </ul>
    </div>
</section>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                <div class="page-notice">
                    ...
                    <ul class="meta">
                        ...
                        <li class="info"><span class="icon"><i class="far fa-calendar-alt"></i></span> <?php echo date($this->setting->sms_date_format, strtotime($notice->date)); ?></li>
                    </ul>
                    <ul class="meta">
            ...
            <div class="col-lg-4 offset-lg-0 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-12">
                <div class="sidebar">
                    <div class="sidebar-widget">
                        <h2 class="sidebar-title"><?php echo $this->lang->line('latest'); ?> <?php echo $this->lang->line('notice'); ?></h2>
                            ...
                            <?php if(isset($notices) && !empty($notices)){ ?>
                                ...
                                <li>
                                    <a href="<?php echo site_url('notice-detail/'.$obj->id); ?>">
                                        ...
                                        <span class="date"><span class="icon"><i class="far fa-calendar-alt"></i></span> <?php echo date($this->setting->sms_date_format, strtotime($obj->date)); ?></span>

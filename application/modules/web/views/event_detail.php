<section class="page-breadcumb-area bg-with-black">
    <div class="container text-center">
        <h2 class="title"><?php echo $this->lang->line('event'); ?> <?php echo $this->lang->line('detail'); ?></h2>
        <ul class="links">
            <li><a href="<?php echo site_url(); ?>"><?php echo $this->lang->line('home'); ?></a></li>
            <li><a href="<?php echo site_url('events'); ?>"><?php echo $this->lang->line('events'); ?></a></li>
            <li><a href="javascript:void(0);"><?php echo $this->lang->line('event'); ?> <?php echo $this->lang->line('detail'); ?></a></li>
        </ul>
    </div>
</section>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                <div class="page-event-details">
                    ...
                    <ul class="event-meta">
                        ...
                        <li class="info"><span class="icon"><i class="far fa-calendar-alt"></i></span> <?php echo date($this->setting->sms_date_format, strtotime($event->event_from)); ?> (<?php echo $this->lang->line('start_date'); ?>)</li>
                        <li class="info"><span class="icon"><i class="far fa-calendar-alt"></i></span> <?php echo date($this->setting->sms_date_format, strtotime($event->event_to)); ?> (<?php echo $this->lang->line('end_date'); ?>)</li>
                                    ...
                                    <a href="<?php echo site_url('event-detail/'.$obj->id); ?>">
                                        ...
                                        <span class="content">
                                            ...
                                            <span class="event-meta">
                                                ...
                                                <span class="info"><span class="icon"><i class="far fa-calendar-alt"></i></span> <?php echo date($this->setting->sms_date_format, strtotime($obj->event_from)); ?> (<?php echo $this->lang->line('start_date'); ?>)</span>
                                                <span class="info"><span class="icon"><i class="far fa-calendar-alt"></i></span> <?php echo date($this->setting->sms_date_format, strtotime($obj->event_to)); ?> (<?php echo $this->lang->line('end_date'); ?>)</span>

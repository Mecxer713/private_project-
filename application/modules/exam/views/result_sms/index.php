<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-envelope-o"></i><small> <?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('absent'); ?> <?php echo $this->lang->line('sms'); ?></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                    ...
                                    <?php $count = 1; if(isset($texts) && !empty($texts)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'exam', 'resultsms')){ ?>     
                                                    <a href="<?php echo site_url('exam/resultsms/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_sms">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('exam/resultsms/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12"  id="fn_tag"  style="padding-top: 6px;">[name] [email] [phone] [exam_result]</div>
                                </div>  
...
<script type="text/javascript">
    ...
    function get_sms_modal(sms_id){
        ...
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('exam/resultsms/get_single_sms'); ?>",
          data   : {sms_id : sms_id},  

            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">                    
                    <ul  class="nav nav-tabs bordered">
                        <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_send_email_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('email'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
                        <li class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#tab_send_email"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-location-arrow"></i> <?php echo $this->lang->line('send'); ?> <?php echo $this->lang->line('email'); ?></a> </li>
                        <?php if(isset($detail)){ ?>
                            <li  class="active"><a href="#tab_view_send_email"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> <?php echo $this->lang->line('email'); ?></a> </li>                          
                        <?php } ?>  
                    </ul>
                    <br/>
                     ...
                     <div class="tab-content"> 
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_send_email">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('exam/mail/send'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('exam/mail'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>

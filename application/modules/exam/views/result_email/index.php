<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-envelope-o"></i><small> <?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('result'); ?> <?php echo $this->lang->line('email'); ?></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                    ...
                                    <?php $count = 1; if(isset($emails) && !empty($emails)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'exam', 'resultemail')){ ?>    
                                                    <a href="<?php echo site_url('exam/resultemail/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_email">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('exam/resultemail/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">  
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="receiver_id"><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('result'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('exam/resultemail/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<script type="text/javascript">
    ...
    function get_email_modal(email_id){
        ...
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('exam/resultemail/get_single_email'); ?>",
   ...
   function get_tag_by_role(role_id){
        $.ajax({       
            ...
            success: function(response){                                                   
               if(response)
               {
                   $('#fn_tag').html(response+'[exam_result]'); 
               }
            }
        }); 
   }

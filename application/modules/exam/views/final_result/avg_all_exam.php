                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo $this->lang->line('obtain'); ?> <?php echo $this->lang->line('mark'); ?> <?php echo $this->lang->line('total'); ?> </th>                                            
                            ...
                            <?php  $result = get_exam_final_result($obj->id, $this->academic_year_id,  $class_id, $section_id ); ?>
                                <tr>
                                    ...
                                    foreach($exams as $ex){
                                       ...
                                       $subject .= (int) $mark->total_subject > 0 ? $mark->total_subject.'<br/>' : '--'.'<br/>';
                                       ...
                                       //(int) $mark->total_subject > 0 ? $total_exam++ : '';
                                       $total_exam++;

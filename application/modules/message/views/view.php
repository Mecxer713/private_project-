                                ...
                                <div class="box-body no-padding">
                                  <div class="mailbox-read-info">
                                    ...
                                    <h5>
                                        ...
                                        <?php } ?>
                                      <span class="mailbox-read-time pull-right"><?php echo date($this->gsms_setting->sms_date_format .' H:i:s a', strtotime($message->created_at)); ?></span>
                                    </h5>
                                  </div>
                                  ...
                                  <?php if(isset($replies) && !empty($replies)){ ?>
                                    ...
                                    <h5>                                      
                                        ...
                                        <span class="mailbox-read-time pull-right"><?php echo date($this->gsms_setting->sms_date_format. ' H:i:s a', strtotime($obj->created_at)); ?></span>
                                    </h5>     
                                      <div class="mailbox-read-message">
